...
### Reisekostenmodul (`apps/travel/`)

- **Modelle:** `TravelExpenseReport`, `TravelDay`, `TravelReceipt`
- **Status-Workflow:** DRAFT → SUBMITTED → APPROVED / REJECTED
- **VMA-Berechnung (2026):** Volltag 28 €, An-/Abreisetag 14 €, eintägige Reise (< 24 h) 14 €; Mahlzeitkürzungen Frühstück 5,60 €, Mittag/Abend je 11,20 €; Übernachtungspauschale 20 €
- **Kilometerpauschale:** 0,30 €/km bei Privatfahrzeug
- **Belegerfassung:** Kategorien (Hotel, Mahlzeit, Taxi, Kraftstoff, Parken, Maut, Fahrkarte, Sonstiges), MwSt.-Ausweis (0 / 7 / 19 %), Fremdwährung + Wechselkurs, Datei-Upload, AG-bezahlt-Flag
- **Verkehrsmittel:** Privat-Pkw, Dienst-Pkw, Bahn (Klasse + BahnCard), Flugzeug (Economy/Business), ÖPNV, Sonstiges
- **PDF-Export** pro Abrechnung (WeasyPrint)
- **HR-Prüfworkflow:** Genehmigen / Ablehnen mit Kommentarfeld; E-Mail-Benachrichtigung
- **Noch nicht implementiert:** Auslandssätze (§ 3 AuslArbG / BMF-Tabellen)
